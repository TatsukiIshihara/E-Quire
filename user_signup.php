...
if (isset($_POST["login"])) {
	...
	$sql = "SELECT * FROM accountdata WHERE accountname = '$username' AND accountpass = '$password'";
// WHEREにaccountnameとaccountpassを指定してるのでどちらもが見つかればその時点でチェックできたことになる。
...
<br>
<input type="button" value="Sign Up" onClick="location.href='insert_activity.php'"
class="register">
</div>
<div class="footer">
	<footer>
